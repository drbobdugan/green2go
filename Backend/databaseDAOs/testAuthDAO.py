...
def main():
    ...
    """
    #testinsertAuth()
    testSelectByEmail()    #select and update do not work yet
    testUpdateAuth()
    #testDeleteAuth()
...
def testUpdateAuth():
    auth = Auth("auth1TestUser@students.stonehill.edu","Ugpmy1lEbwaNoIqZmkjBkkzOtskzYquyL11ISH5ij9iRL","l9R51hFTGUgV0LeyJJAkwbSiZL1dfennuGDlPcUJnnNm9","2021-01-01 01:01:01")
    dao.updateAuth(auth)
